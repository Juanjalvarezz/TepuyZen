...
export default function Slider() {
  ...
  return (
    <div className="max-w-[1200px] h-[350px] w-full py-1 px-4 relative mt-5 mb-2 group m-auto">
      <div className="relative w-full h-full rounded-2xl bg-center bg-cover duration-500">
        ...
        <div className="absolute bottom-0 left-0 right-0 flex justify-center py-2 text-white">
